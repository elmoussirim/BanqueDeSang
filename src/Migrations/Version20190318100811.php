 ...
 */
final class Version20190318100811 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande_sang CHANGE nom_service_id service_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande_sang CHANGE service_id nom_service_id INT NOT NULL');
